      ...
      <div class="box-header with-border">
       ...
       <div class="form-group">
        <label>Tanggal</label>
          <div class="row">
            <div class="col-xs-3">
              <input required type="date" value="<?=$pasien->tanggal_masuk?>" name="tanggal_masuk" class="form-control" name="">
            </div>
            <div class="col-xs-2">
              <!-- time Picker -->
              <div class="bootstrap-timepicker">
                  <div class="input-group">
                    <input type="time" name="jam_masuk" value="<?= $pasien->jam_masuk?>" class="form-control">
                  </div>
            </div>
          </div>
      </div>
...
<div class="box">
    ...
    <tbody>
    <?php $no=1; foreach ($pasien_result as $us ) { ?>
    <tr>
      <td><?= $no++ ?></td>

	    ...
	    <div class="row">
	      ...
	      <div class="col-xs-4">
	      	...
	      	<select class="form-control" required name="alasan_keluar">
	      		...
	      		<option>Pilih</option>
	      		<option <?php if ($pasien->alasan_keluar==='1') { echo "selected"; } ?> value="1">Sehat</option>
	      		<option <?php if ($pasien->alasan_keluar==='2') { echo "selected"; } ?> value="2">Rujuk</option>
	      		<option <?php if ($pasien->alasan_keluar==='3') { echo "selected"; } ?> value="3">Wafat</option>
	      		<option <?php if ($pasien->alasan_keluar==='4') { echo "selected"; } ?> value="4">Evakuasi</option>
	      		<option <?php if ($pasien->alasan_keluar==='5') { echo "selected"; } ?> value="5">Konsultasi</option>
	      		<option <?php if ($pasien->alasan_keluar==='6') { echo "selected"; } ?> value="6">Rawat Inap</option>
	      	</select>
	      </div>
	    </div>
	</div>

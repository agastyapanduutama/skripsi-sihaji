<!-- <script>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 Bird Feathers.</strong> 
    reserved.
  </footer>
...
<script>
  ...
  <script src="<?= base_url('assets/js/page/admin.js') ?>" type="text/javascript"></script>
  <script src="<?= base_url('assets/js/page/' . (isset($script) ? $script : null)  . ".js") ?>" type="text/javascript">
  </script>
